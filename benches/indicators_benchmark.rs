...
// extern crate test;
//
// fn midprice_bench(bid: u64, ask: u64) -> f32 {
//     black_box(midprice(black_box(bid), black_box(ask)) as u64) as f32
// }
//
// fn better_midprice_bench(bid: u64, ask: u64) -> f32 {
//     better_black_box(midprice(better_black_box(bid), better_black_box(ask)) as u64) as f32
// }
//
// #[cfg(test)]
// mod tests {
